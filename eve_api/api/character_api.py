...
class CharacterApi(object):
    ...
    def get_characters_character_id_portrait(self, character_id, **kwargs):  # noqa: E501
        ...
        Get portrait urls for a character  ---  This route expires daily at 11:05  --- [Diff of the upcoming changes](https://esi.evetech.net/diff/latest/dev/#GET-/characters/{character_id}/portrait/)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_characters_character_id_stats(self, character_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_characters_character_id_stats(character_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_characters_character_id_stats_with_http_info(self, character_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_characters_character_id_stats_with_http_info(character_id, async_req=True)
        >>> result = thread.get()
