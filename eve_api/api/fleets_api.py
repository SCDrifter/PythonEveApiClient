...
class FleetsApi(object):
    ...
    def put_fleets_fleet_id_with_http_info(self, fleet_id, new_settings, **kwargs):  # noqa: E501
        ...
        if ('new_settings' not in params or
