...
class GetCorporationsCorporationIdContractsContractIdBids200Ok(object):
    ...
    def __init__(self, amount=None, bid_id=None, bidder_id=None, date_bid=None, _configuration=None):  # noqa: E501
    ...
    def bidder_id(self, bidder_id):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and bidder_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetCorporationsCorporationIdContractsContractIdBids200Ok, dict):
