...
class GetUniverseBloodlines200Ok(object):
    ...
    def __init__(self, bloodline_id=None, charisma=None, corporation_id=None, description=None, intelligence=None, memory=None, name=None, perception=None, race_id=None, ship_type_id=None, willpower=None):  # noqa: E501
