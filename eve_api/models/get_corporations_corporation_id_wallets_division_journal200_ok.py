...
class GetCorporationsCorporationIdWalletsDivisionJournal200Ok(object):
    ...
    def __init__(self, amount=None, balance=None, context_id=None, context_id_type=None, _date=None, description=None, first_party_id=None, id=None, reason=None, ref_type=None, second_party_id=None, tax=None, tax_receiver_id=None):  # noqa: E501
