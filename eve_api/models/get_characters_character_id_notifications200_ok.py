...
class GetCharactersCharacterIdNotifications200Ok(object):
    ...
    def __init__(self, is_read=None, notification_id=None, sender_id=None, sender_type=None, text=None, timestamp=None, type=None):  # noqa: E501
