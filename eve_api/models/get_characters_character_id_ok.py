...
class GetCharactersCharacterIdOk(object):
    ...
    def __init__(self, alliance_id=None, ancestry_id=None, birthday=None, bloodline_id=None, corporation_id=None, description=None, faction_id=None, gender=None, name=None, race_id=None, security_status=None, title=None):  # noqa: E501
