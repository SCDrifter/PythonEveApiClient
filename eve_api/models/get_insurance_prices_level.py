...
class GetInsurancePricesLevel(object):
    ...
    def __init__(self, cost=None, name=None, payout=None, _configuration=None):  # noqa: E501
    ...
    def payout(self, payout):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and payout is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetInsurancePricesLevel, dict):
