...
class PostCharactersCharacterIdFittingsItem(object):
    ...
    def __init__(self, flag=None, quantity=None, type_id=None):  # noqa: E501
    ...
    def flag(self):
        ...
        Fitting location for the item. Entries placed in 'Invalid' will be discarded. If this leaves the fitting with nothing, it will cause an error.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PostCharactersCharacterIdFittingsItem, dict):
