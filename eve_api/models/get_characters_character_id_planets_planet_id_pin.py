...
class GetCharactersCharacterIdPlanetsPlanetIdPin(object):
    ...
    def __init__(self, contents=None, expiry_time=None, extractor_details=None, factory_details=None, install_time=None, last_cycle_start=None, latitude=None, longitude=None, pin_id=None, schematic_id=None, type_id=None):  # noqa: E501
