...
class GetKillmailsKillmailIdKillmailHashAttacker(object):
    ...
    def __init__(self, alliance_id=None, character_id=None, corporation_id=None, damage_done=None, faction_id=None, final_blow=None, security_status=None, ship_type_id=None, weapon_type_id=None):  # noqa: E501
