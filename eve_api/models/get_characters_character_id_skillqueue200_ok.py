...
class GetCharactersCharacterIdSkillqueue200Ok(object):
    ...
    def __init__(self, finish_date=None, finished_level=None, level_end_sp=None, level_start_sp=None, queue_position=None, skill_id=None, start_date=None, training_start_sp=None):  # noqa: E501
    ...
    def finished_level(self, finished_level):
        ...
        if finished_level is not None and finished_level > 5:  # noqa: E501
            raise ValueError("Invalid value for `finished_level`, must be a value less than or equal to `5`")  # noqa: E501
        if finished_level is not None and finished_level < 0:  # noqa: E501
