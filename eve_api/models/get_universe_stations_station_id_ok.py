...
class GetUniverseStationsStationIdOk(object):
    ...
    def __init__(self, max_dockable_ship_volume=None, name=None, office_rental_cost=None, owner=None, position=None, race_id=None, reprocessing_efficiency=None, reprocessing_stations_take=None, services=None, station_id=None, system_id=None, type_id=None):  # noqa: E501
