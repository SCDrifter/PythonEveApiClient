...
class GetUniverseFactions200Ok(object):
    ...
    def __init__(self, corporation_id=None, description=None, faction_id=None, is_unique=None, militia_corporation_id=None, name=None, size_factor=None, solar_system_id=None, station_count=None, station_system_count=None):  # noqa: E501
