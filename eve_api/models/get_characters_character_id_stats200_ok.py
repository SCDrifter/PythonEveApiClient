...
class GetCharactersCharacterIdStats200Ok(object):
    ...
    def __init__(self, character=None, combat=None, industry=None, inventory=None, isk=None, market=None, mining=None, module=None, orbital=None, pve=None, social=None, travel=None, year=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetCharactersCharacterIdStats200Ok, dict):
