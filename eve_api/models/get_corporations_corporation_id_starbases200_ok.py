...
class GetCorporationsCorporationIdStarbases200Ok(object):
    ...
    def __init__(self, moon_id=None, onlined_since=None, reinforced_until=None, starbase_id=None, state=None, system_id=None, type_id=None, unanchor_at=None):  # noqa: E501
