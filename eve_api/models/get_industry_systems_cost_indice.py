...
class GetIndustrySystemsCostIndice(object):
    ...
    def __init__(self, activity=None, cost_index=None, _configuration=None):  # noqa: E501
    ...
    def activity(self, activity):
        ...
        if (self._configuration.client_side_validation and
                activity not in allowed_values):
            raise ValueError(
    ...
    def cost_index(self, cost_index):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and cost_index is None:
