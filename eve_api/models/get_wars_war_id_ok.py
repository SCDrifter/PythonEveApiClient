...
class GetWarsWarIdOk(object):
    ...
    def __init__(self, aggressor=None, allies=None, declared=None, defender=None, finished=None, id=None, mutual=None, open_for_allies=None, retracted=None, started=None):  # noqa: E501
