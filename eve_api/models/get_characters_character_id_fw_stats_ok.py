...
class GetCharactersCharacterIdFwStatsOk(object):
    ...
    def __init__(self, current_rank=None, enlisted_on=None, faction_id=None, highest_rank=None, kills=None, victory_points=None):  # noqa: E501
    ...
    def current_rank(self, current_rank):
        ...
        :type: int
        """
        if current_rank is not None and current_rank > 9:  # noqa: E501
            raise ValueError("Invalid value for `current_rank`, must be a value less than or equal to `9`")  # noqa: E501
        if current_rank is not None and current_rank < 0:  # noqa: E501
    ...
    def highest_rank(self, highest_rank):
        ...
        :type: int
        """
        if highest_rank is not None and highest_rank > 9:  # noqa: E501
            raise ValueError("Invalid value for `highest_rank`, must be a value less than or equal to `9`")  # noqa: E501
        if highest_rank is not None and highest_rank < 0:  # noqa: E501
