...
class GetCharactersCharacterIdAttributesOk(object):
    ...
    def __init__(self, accrued_remap_cooldown_date=None, bonus_remaps=None, charisma=None, intelligence=None, last_remap_date=None, memory=None, perception=None, willpower=None):  # noqa: E501
