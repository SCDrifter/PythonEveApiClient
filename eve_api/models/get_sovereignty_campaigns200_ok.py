...
class GetSovereigntyCampaigns200Ok(object):
    ...
    def __init__(self, attackers_score=None, campaign_id=None, constellation_id=None, defender_id=None, defender_score=None, event_type=None, participants=None, solar_system_id=None, start_time=None, structure_id=None):  # noqa: E501
