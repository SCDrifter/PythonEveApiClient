...
class GetUniverseGraphicsGraphicIdOk(object):
    ...
    def __init__(self, collision_file=None, graphic_file=None, graphic_id=None, icon_folder=None, sof_dna=None, sof_fation_name=None, sof_hull_name=None, sof_race_name=None):  # noqa: E501
