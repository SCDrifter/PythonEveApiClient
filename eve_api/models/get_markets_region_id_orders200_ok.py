...
class GetMarketsRegionIdOrders200Ok(object):
    ...
    def __init__(self, duration=None, is_buy_order=None, issued=None, location_id=None, min_volume=None, order_id=None, price=None, range=None, system_id=None, type_id=None, volume_remain=None, volume_total=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetMarketsRegionIdOrders200Ok, dict):
