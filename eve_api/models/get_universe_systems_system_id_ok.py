...
class GetUniverseSystemsSystemIdOk(object):
    ...
    def __init__(self, constellation_id=None, name=None, planets=None, position=None, security_class=None, security_status=None, star_id=None, stargates=None, stations=None, system_id=None):  # noqa: E501
