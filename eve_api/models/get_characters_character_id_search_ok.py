...
class GetCharactersCharacterIdSearchOk(object):
    ...
    def __init__(self, agent=None, alliance=None, character=None, constellation=None, corporation=None, faction=None, inventory_type=None, region=None, solar_system=None, station=None, structure=None):  # noqa: E501
