...
class GetDogmaAttributesAttributeIdOk(object):
    ...
    def __init__(self, attribute_id=None, default_value=None, description=None, display_name=None, high_is_good=None, icon_id=None, name=None, published=None, stackable=None, unit_id=None):  # noqa: E501
