...
class GetCharactersCharacterIdCalendarEventIdOk(object):
    ...
    def __init__(self, _date=None, duration=None, event_id=None, importance=None, owner_id=None, owner_name=None, owner_type=None, response=None, text=None, title=None):  # noqa: E501
