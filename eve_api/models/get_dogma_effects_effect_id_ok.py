...
class GetDogmaEffectsEffectIdOk(object):
    ...
    def __init__(self, description=None, disallow_auto_repeat=None, discharge_attribute_id=None, display_name=None, duration_attribute_id=None, effect_category=None, effect_id=None, electronic_chance=None, falloff_attribute_id=None, icon_id=None, is_assistance=None, is_offensive=None, is_warp_safe=None, modifiers=None, name=None, post_expression=None, pre_expression=None, published=None, range_attribute_id=None, range_chance=None, tracking_speed_attribute_id=None):  # noqa: E501
