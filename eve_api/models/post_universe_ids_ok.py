...
class PostUniverseIdsOk(object):
    ...
    def __init__(self, agents=None, alliances=None, characters=None, constellations=None, corporations=None, factions=None, inventory_types=None, regions=None, stations=None, systems=None):  # noqa: E501
