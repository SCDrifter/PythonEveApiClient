...
class GetCharactersCharacterIdMedals200Ok(object):
    ...
    def __init__(self, corporation_id=None, _date=None, description=None, graphics=None, issuer_id=None, medal_id=None, reason=None, status=None, title=None):  # noqa: E501
