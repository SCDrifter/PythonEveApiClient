...
class GetCorporationsCorporationIdStructures200Ok(object):
    ...
    def __init__(self, corporation_id=None, fuel_expires=None, next_reinforce_apply=None, next_reinforce_hour=None, next_reinforce_weekday=None, profile_id=None, reinforce_hour=None, reinforce_weekday=None, services=None, state=None, state_timer_end=None, state_timer_start=None, structure_id=None, system_id=None, type_id=None, unanchors_at=None):  # noqa: E501
        ...
        if reinforce_weekday is not None:
