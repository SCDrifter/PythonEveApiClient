...
class GetAlliancesAllianceIdOk(object):
    ...
    def __init__(self, creator_corporation_id=None, creator_id=None, date_founded=None, executor_corporation_id=None, faction_id=None, name=None, ticker=None):  # noqa: E501
