...
class GetCorporationsCorporationIdWalletsDivisionTransactions200Ok(object):
    ...
    def __init__(self, client_id=None, _date=None, is_buy=None, journal_ref_id=None, location_id=None, quantity=None, transaction_id=None, type_id=None, unit_price=None):  # noqa: E501
