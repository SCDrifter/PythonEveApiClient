...
class GetKillmailsKillmailIdKillmailHashVictim(object):
    ...
    def __init__(self, alliance_id=None, character_id=None, corporation_id=None, damage_taken=None, faction_id=None, items=None, position=None, ship_type_id=None):  # noqa: E501
