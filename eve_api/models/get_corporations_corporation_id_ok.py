...
class GetCorporationsCorporationIdOk(object):
    ...
    def __init__(self, alliance_id=None, ceo_id=None, creator_id=None, date_founded=None, description=None, faction_id=None, home_station_id=None, member_count=None, name=None, shares=None, tax_rate=None, ticker=None, url=None, war_eligible=None):  # noqa: E501
