...
class GetCharactersCharacterIdPlanetsPlanetIdLink(object):
    ...
    def __init__(self, destination_pin_id=None, link_level=None, source_pin_id=None):  # noqa: E501
    ...
    def link_level(self, link_level):
        ...
        if link_level is not None and link_level > 10:  # noqa: E501
            raise ValueError("Invalid value for `link_level`, must be a value less than or equal to `10`")  # noqa: E501
        if link_level is not None and link_level < 0:  # noqa: E501
