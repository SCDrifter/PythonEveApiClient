...
class GetContractsPublicItemsContractId200Ok(object):
    ...
    def __init__(self, is_blueprint_copy=None, is_included=None, item_id=None, material_efficiency=None, quantity=None, record_id=None, runs=None, time_efficiency=None, type_id=None):  # noqa: E501
